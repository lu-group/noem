...
import heat_transfer.fem_solver.don_solver as don_solver

def get_fem_model(mesh_size, width, height, radius, mesh_size_circle=None):
    from heat_transfer.fem_solver import meshing
...
def run_bc1():
    ...
    import heat_transfer.single_hole_problem.get_don_mesh as get_don_mesh
    ...
    left_T_BC = np.load("single_hole_problem//bc1.npz")['left_T_BC']
    right_T_BC = np.load("single_hole_problem//bc1.npz")['right_T_BC']
    ...
    import heat_transfer.single_hole_problem.visualization as visualization
    fem_results_fig_name = "single_hole_problem//results//fem_results.png"
    ...
    don_results_fig_name = "single_hole_problem//results//don_results.png"
    ...
    diff_results_fig_name = "single_hole_problem//results//diff_results.png"
    ...
    plt.tight_layout()
    plt.savefig("single_hole_problem//results//combined results.png")
    plt.show()
...
def run_bc2():
    ...
    left_T_BC = np.load("single_hole_problem//bc2.npz")['left_T_BC']
    right_T_BC = np.load("single_hole_problem//bc2.npz")['right_T_BC']
