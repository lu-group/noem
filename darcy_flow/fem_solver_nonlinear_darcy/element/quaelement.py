        ...
        for b in range(2):
            ...
            for i in range(4):
                for j in range(4):
                    ...
                    if k == 0:
                        Ni = N(i, xi, eta)
                        # Compute the temperature at the integration point according to the temperature at each node in T and shape function
                        T_int = 0
                        for l in range(4):
                            T_int += T[l] * N(l, xi, eta)
                        k = 1 / (abs(T_int) + 0.1)
