...
import darcy_flow.nonlinear_permeability.visualization as visualization
import os, torch
import darcy_flow.fem_solver_nonlinear_darcy.fem_solver as fem_solver
from darcy_flow.fem_solver_nonlinear_darcy.don_solver import one_solver
...
def run(net_name="deeponet_nonlinear_darcy.pth",
        results_name=None):
    x_len = y_len = 2.0
    num_x = num_y = 40
    ...
    from darcy_flow.fem_solver_nonlinear_darcy.element import don_element_nonlinear_darcy as don_element
