...
from ex4.fem_solver.don_solver import one_solver
...
def run(net_name = "..//data_driven_training//ex4_darcy//ex4.1.pth", results_name=None):
    x_len = y_len = 2.0
    num_x = num_y = 40
    ...
    from ex4.fem_solver.element import don_element as don_element
